...
import org.ssafy.d210.halleyGalley.dto.request.*;
...
public class HalleyGalleyController {
    ...
    @PutMapping("/use-dayoff")
    public ApiResponseDto<?> putDayoff(@AuthenticationPrincipal UserDetailsImpl userDetails, @RequestBody PutDayoffRequest request){
        return ApiResponseDto.of(MsgType.PUT_DAYOFF_SUCCESSFULLY, halleyGalleyService.putDayoff(userDetails.getMember(), request));
    }
}
